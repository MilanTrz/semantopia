...
export const GAMES: GameConfig[] = [
	{ 
		...
		description: 'Trouver le mot mystère grâce aux associations sémantiques et à votre grande intellecte'
	},
	{ 
		slug: 'pedantix', 
		label: 'Pédantix', 
		...
		description: 'Découvrer l\'article Wikipédia caché mot par mot dans ce jeu de déduction'
	},
	{ 
		slug: 'motix', 
		label: 'Motix', 
	...
	{ 
		...
		description: 'Trouver les mots liés par des corrélations surprenantes et logiques'
	},
	{ 
		slug: 'lettix', 
		label: 'Lettix', 
		...
		description: 'Trouver un maximum d\'anagrammes en 60 secondes'
	},
	{ 
		slug: 'mimix', 
		label: 'Mimix', 
		...
		description: 'Trouver le plus de fois l\'intrus parmi les 4 propositions'
	},
	{ 
		slug: 'panix', 
		label: 'Panix', 
	...
	{ 
		...
		description: 'Enchaîner des mots où chaque fin devient le début du suivant en 60 secondes.'
	}
];
